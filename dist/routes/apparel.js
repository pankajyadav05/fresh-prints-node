...
import { BulkUpdateValidation, OrderValidation, StockPriceValidation, } from "../validations/apparel.validations.js";
const ApparelRouter = (app) => {
    const service = new ApparelService();
    // Route to update the stock quality and price of one apparel code and size
    app.put("/apparel/:code/size/:size", StockPriceValidation, Validate, tryCatch(async (req, res) => {
        const { code, size } = req.params;
        const { stockQuality, price } = req.body;
    ...
    app.put("/apparel/bulk", BulkUpdateValidation, Validate, tryCatch(async (req, res) => {
    ...
    app.post("/order/fulfillment", OrderValidation, Validate, tryCatch(async (req, res) => {
    ...
    app.post("/order/lowest-cost", OrderValidation, Validate, tryCatch(async (req, res) => {
        const order = req.body;
...
//# sourceMappingURL=apparel.js.map